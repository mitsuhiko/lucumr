...
1if one wants to argue that this is obvious: it should be.  But
...
2if you however set `__module__` to `None` you will notice
...
3I actually made a mistake in this benchmark.  As correctly
